...
export default function About() {
  ...
  return (
    <section id="about" className="bg-brand-bg py-16 text-brand-charcoal sm:py-20" aria-labelledby="about-title">
      <div className="section-shell grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        ...
        >
          <h2 id="about-title" className="font-display text-4xl font-normal leading-tight text-brand-charcoal sm:text-5xl">
            About DECENT
            <br />
            Development
          </h2>
        ...
        <motion.div
          ...
          className="space-y-6 text-base font-light leading-8 text-brand-muted"
        >
          <p className="font-semibold text-brand-charcoal">We deliver construction and development with a premium standard of care.</p>
          <p>
